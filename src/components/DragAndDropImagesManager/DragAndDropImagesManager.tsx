...
const DragAndDropImagesManager = ({ children }: DragAndDropImagesManagerProps) => {
    ...
    const contextValue = { selectedImagesIds, onDragStart,  onDragEnd, onDragLeave,
        onDragOver, onDrop, onReorderImage, onSelectImage, onDeleteImage, onSelectAllImages,
        onDeselectAllImages, onDeleteSelectedImages
    }
    return <>
